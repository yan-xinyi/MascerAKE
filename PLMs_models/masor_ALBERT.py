...
class ALBertNerModel(nn.Module):
    ...
    def __init__(self, bert_weight, num_labels=6, fs_num=0, tokenizer=None, vocab_feature_dict={}, oov_feature_dict={},
        ...
        self.albert = AlbertModel.from_pretrained(bert_weight)
...
def main():
    ...
    # 模型参数
    parser.add_argument('--bert_weight', type=str, default='albert-base-v2',
                        help='BERT模型名称')
    ...
    parser.add_argument('--model_path', type=str, default='./best_albert_model.pt', help='保存模型路径')
    ...
    # 初始化分词器
    tokenizer = AlbertTokenizerFast.from_pretrained(args.bert_weight)
